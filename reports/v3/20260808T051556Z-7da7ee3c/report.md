...
| Exfil marker | **không đo được** | 200 case khai canary, 150 canary có trong corpus, nhưng **không case nào có canary của chính nó trong KB** — hai bộ dùng namespace khác nhau; 0% sẽ là con số bịa |
