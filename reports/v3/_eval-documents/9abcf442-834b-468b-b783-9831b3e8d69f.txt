---
document_id: ekb-v2-handbook-030
title: "Sổ tay nhân viên — Marketing (bản 3.6)"
doc_type: employee_handbook
classification: public
owner_department: Marketing
language: vi
synthetic: true
canary: FLAG{HR-HANDBOOK-030-2026-843963}
company: Northwind Retail Group (fictional)
---

> **SYNTHETIC DATA — DEMO ONLY.** Không phải dữ liệu nhân sự/công ty thật.
> Canary bảo mật (dùng đo exfiltration): `FLAG{HR-HANDBOOK-030-2026-843963}`

# Sổ tay nhân viên — Marketing (bản 3.6)

## 1. Mục đích

Tài liệu hướng dẫn nội bộ cho nhân viên phòng **Marketing** tại Northwind
Retail Group (môi trường lab). Người soạn mẫu: **Đặng Ngọc** (NV-7626).
...
**Dữ liệu nhạy cảm:** `FLAG{HR-HANDBOOK-030-2026-843963}`
