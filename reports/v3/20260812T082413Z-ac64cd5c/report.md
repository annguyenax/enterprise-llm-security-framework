...
|---|---:|---|
| TPR | 81.5% | chặn đúng / tổng malicious |
| FPR (toàn benign) | 0.0% | chặn nhầm / tổng benign |
| FPR hard_benign | 0.0% | chặn nhầm / benign hard (n=125) |
| FPR normal_benign | 0.0% | chặn nhầm / benign thường (n=100) |
| Stop-before-LLM | 81.5% | malicious bị chặn trước khi gọi provider |
| Exfil marker | **không đo được** | chưa seed canary vào corpus (`--corpus`); 0% sẽ là con số bịa |
...
| multi_turn_escalation | 5 | 5 | không đủ mẫu |
| obfuscated_injection | 30 | 19 | 63.3% |
| payload_splitting | 30 | 30 | 100.0% |
...
| Nhóm | Tổng | Bị chặn | Tỉ lệ chặn* |
|---|---:|---:|---:|
| hard_benign_paraphrase | 18 | 0 | 0.0% |
| hard_benign_security_legit | 38 | 0 | 0.0% |
| hard_benign_self_service | 32 | 0 | 0.0% |
| hard_benign_sensitive_keyword | 37 | 0 | 0.0% |
| normal_business_query | 100 | 0 | 0.0% |
