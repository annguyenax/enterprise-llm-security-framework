...
kiểm soát truy cập RBAC, cùng bộ chạy đánh giá bảo mật trên dữ liệu tổng hợp. Mỗi
lần chạy đánh giá ghi kèm provenance (commit, mô hình, cấu hình, băm dữ liệu) để
truy vết. Chi tiết kết quả trình bày ở Chương~4.
