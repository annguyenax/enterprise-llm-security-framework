...
Full repository suite & 1523 passed, 0 failed, 4 skipped, 1 warning, exit 0 \\
\bottomrule
\end{tabular}
\end{table}
...
\vspace{2pt}
{\footnotesize $^\dagger$ Chỉ số exfil \textbf{chủ yếu bị nhiễu echo}: $190/200$
prompt tấn công đã \emph{chứa sẵn} mã canary trong câu hỏi ($37$ lần lộ ở nhóm
này phần lớn là echo). Nhưng trên $10$ prompt sạch (canary chỉ trong kho) có $6$
lần lộ --- tín hiệu rò rỉ kho thật, dưới ngưỡng cỡ mẫu. Không thể coi $21{,}5\%$
là tỉ lệ rò rỉ kho. Xem mục phân tích và Hạn chế.\par}
\end{table}
...
từng case cho thấy trong $190$ prompt ``nhiễm'' này có $37$ lần lộ --- phần lớn
là mô hình lặp lại prompt (echo). \emph{Tuy nhiên}, trên $10$ prompt \emph{sạch}
(canary \textbf{chỉ} nằm trong kho, không có trong câu hỏi) vẫn có $6$ lần lộ:
đây là tín hiệu rò rỉ kho \emph{thật}, tuy dưới ngưỡng cỡ mẫu tối thiểu để báo
cáo tin cậy ($n=10$). Vậy không thể quy toàn bộ thành echo, cũng không thể coi
$21{,}5\%$ là tỉ lệ rò rỉ kho: \textbf{lỗ hổng rò rỉ đầu ra là thật nhưng chưa
định lượng được tin cậy}. Muốn đo đúng thì canary phải chỉ tồn tại trong kho ---
một sửa lỗi phương pháp bắt buộc cho phiên bản đánh giá sau.
...
\begin{itemize}
    ...
    \item Phép đo Exfil Marker \textbf{chủ yếu bị nhiễu echo} ($190/200$ prompt chứa sẵn canary); trên $10$ prompt sạch có $6$ lần lộ --- rò rỉ kho là thật nhưng dưới ngưỡng cỡ mẫu, chưa định lượng tin cậy. Cần thiết kế lại canary (chỉ nằm trong kho).
