...
title: Hợp đồng lao động mẫu — it.user1
department: hr
owner: hr.leader
...
related_employee_id: it.user1
allowed_users: it.user1,hr.leader
approved_by: hr.leader
version: 1.0
---

Hợp đồng lao động tổng hợp dành riêng cho tài khoản `it.user1`.
