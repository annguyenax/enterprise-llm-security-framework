...
title: Hợp đồng lao động mẫu — hr.leader
department: hr
owner: hr.leader
...
related_employee_id: hr.leader
allowed_users: hr.leader
approved_by: hr.leader
version: 1.0
---

Hợp đồng lao động tổng hợp dành riêng cho tài khoản `hr.leader`.
